...
@SpireInitializer
public class SkyStrikerMod implements
        EditCardsSubscriber,
    ...
    // Character assets
    private static final String THE_DEFAULT_BUTTON = "skyStrikerResources/images/charSelect/SkyStrikerCharacterButton.png";
    private static final String THE_DEFAULT_PORTRAIT = "skyStrikerResources/images/charSelect/SkyStrikerCharacterPortraitBG.png";
    public static final String THE_DEFAULT_SHOULDER_1 = "skyStrikerResources/images/char/defaultCharacter/shoulder.png";
    public static final String THE_DEFAULT_SHOULDER_2 = "skyStrikerResources/images/char/defaultCharacter/shoulder2.png";
    public static final String THE_DEFAULT_CORPSE = "skyStrikerResources/images/char/defaultCharacter/corpse.png";
    
    //Mod Badge - A small icon that appears in the mod settings menu next to your mod.
    public static final String BADGE_IMAGE = "skyStrikerResources/images/Badge.png";
    ...
    public static void setModID(String ID) { // DON'T EDIT
        ...
        InputStream in = SkyStrikerMod.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THIS ETHER
    ...
    private static void pathCheck() { // ALSO NO
        ...
        InputStream in = SkyStrikerMod.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THISSSSS
        IDCheckDontTouchPls EXCEPTION_STRINGS = coolG.fromJson(new InputStreamReader(in, StandardCharsets.UTF_8), IDCheckDontTouchPls.class); // NAH, NO EDIT
        String packageName = SkyStrikerMod.class.getPackage().getName(); // STILL NO EDIT ZONE
...
//        UnlockTracker.markRelicAsSeen(BottledPlaceholderRelic.ID);
    ...
    public void receiveEditCards() {
        ...
        new AutoAdd("skyStriker") // ${project.artifactId}
