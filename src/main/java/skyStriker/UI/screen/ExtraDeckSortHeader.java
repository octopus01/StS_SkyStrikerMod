...
public class ExtraDeckSortHeader extends CardLibSortHeader {
    ...
    private SSExtraDeckScreen ssExtraDeckScreen;
    private float scrollY;

    public ExtraDeckSortHeader(SSExtraDeckScreen ssExtraDeckScreen) {
        super((CardGroup)null);
        this.ssExtraDeckScreen = ssExtraDeckScreen;
    ...
    public ExtraDeckSortHeader(CardGroup group) {
        super(group);
    }
    ...
    public void didChangeOrder(SortHeaderButton button, boolean isAscending) {
        ...
        if (button == this.buttons[0]) {
            if (isAscending) {
                this.ssExtraDeckScreen.setSortOrder((Comparator)null);
            } else {
                this.ssExtraDeckScreen.setSortOrder(PURE_REVERSE);
            }
            ...
            this.ssExtraDeckScreen.setSortOrder(order);
        }
    }
