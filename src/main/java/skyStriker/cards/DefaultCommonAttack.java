...
public class DefaultCommonAttack extends CustomCard {
    ...
    public static final String ID = SkyStrikerMod.makeID(DefaultCommonAttack.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("Attack.png");
    // Setting the image  as easy as can possibly be now. You just need to provide the image name
