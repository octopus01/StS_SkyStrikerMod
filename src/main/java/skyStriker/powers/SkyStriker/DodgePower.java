...
public class DodgePower extends AbstractPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = SkyStrikerMod.makeID("DodgePower");
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("Dodge84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("Dodge32.png"));

    public DodgePower( AbstractCreature owner, int turns) {
        name = NAME;
        ID = POWER_ID;
